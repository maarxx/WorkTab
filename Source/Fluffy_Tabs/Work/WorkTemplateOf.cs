namespace Fluffy_Tabs
{
    internal static class WorkTemplateOf
    {
        ...
        static WorkTemplateOf()
        {
            ...
            DEFAULT.baseline.Add(MyMapper.s("feed,60"), 3);
            ...
            DEFAULT.baseline.Add(MyMapper.s("fill,50"), 3);
            DEFAULT.baseline.Add(MyMapper.s("brew,30"), 3);
            ...
            DEFAULT.baseline.Add(MyMapper.s("work on,40"), 3);
            DEFAULT.baseline.Add(MyMapper.s("work on,30"), 3);
            DEFAULT.baseline.Add(MyMapper.s("deconstruct,20"), 3);
            DEFAULT.baseline.Add(MyMapper.s("uninstall,19"), 3);
            ...
            DEFAULT.baseline.Add(MyMapper.s("unload,120"), 3);
            DEFAULT.baseline.Add(MyMapper.s("load,110"), 3);
            DEFAULT.baseline.Add(MyMapper.s("strip,100"), 3);
            DEFAULT.baseline.Add(MyMapper.s("bury,90"), 3);
            DEFAULT.baseline.Add(MyMapper.s("haul,80"), 2);
            DEFAULT.baseline.Add(MyMapper.s("open,70"), 3);
            DEFAULT.baseline.Add(MyMapper.s("refuel,60"), 3);
            DEFAULT.baseline.Add(MyMapper.s("rearm,50"), 3);
            DEFAULT.baseline.Add(MyMapper.s("cremate,40"), 3);
            DEFAULT.baseline.Add(MyMapper.s("work at,30"), 3);
            DEFAULT.baseline.Add(MyMapper.s("take beer,20"), 3);
            DEFAULT.baseline.Add(MyMapper.s("fill,19"), 3);

            DEFAULT.baseline.Add(MyMapper.s("haul,10"), 6);
            ...
            DEFAULT.ifInterest.Add(MyMapper.s("remove floor,10"), 3);
            DEFAULT.ifInterest.Add(MyMapper.s("smooth,5"), 3);
            ...
            DEFAULT.nameFlagOverrides.Add(new NameFlagOverride("H", MyMapper.s("tame,80"), 4));
            DEFAULT.nameFlagOverrides.Add(new NameFlagOverride("h", MyMapper.s("tame,80"), 5));
            DEFAULT.nameFlagOverrides.Add(new NameFlagOverride("H", MyMapper.s("train,70"), 4));
            DEFAULT.nameFlagOverrides.Add(new NameFlagOverride("h", MyMapper.s("train,70"), 5));

            DEFAULT.nameFlagOverrides.Add(new NameFlagOverride("G", MyMapper.s("harvest,100"), 4));
            DEFAULT.nameFlagOverrides.Add(new NameFlagOverride("g", MyMapper.s("harvest,100"), 5));
            DEFAULT.nameFlagOverrides.Add(new NameFlagOverride("G", MyMapper.s("sow,50"), 4));
            DEFAULT.nameFlagOverrides.Add(new NameFlagOverride("g", MyMapper.s("sow,50"), 5));

            DEFAULT.nameFlagOverrides.Add(new NameFlagOverride("M", MyMapper.s("mine,100"), 4));
            DEFAULT.nameFlagOverrides.Add(new NameFlagOverride("m", MyMapper.s("mine,100"), 5));
            DEFAULT.nameFlagOverrides.Add(new NameFlagOverride("M", MyMapper.s("drill,50"), 4));
            DEFAULT.nameFlagOverrides.Add(new NameFlagOverride("m", MyMapper.s("drill,50"), 5));

            DEFAULT.nameFlagOverrides.Add(new NameFlagOverride("C", MyMapper.s("smith,115"), 4));
            DEFAULT.nameFlagOverrides.Add(new NameFlagOverride("c", MyMapper.s("smith,115"), 5));
            DEFAULT.nameFlagOverrides.Add(new NameFlagOverride("C", MyMapper.s("work,75"), 4));
            DEFAULT.nameFlagOverrides.Add(new NameFlagOverride("c", MyMapper.s("work,75"), 5));
            DEFAULT.nameFlagOverrides.Add(new NameFlagOverride("C", MyMapper.s("produce components,50"), 4));
            DEFAULT.nameFlagOverrides.Add(new NameFlagOverride("c", MyMapper.s("produce components,50"), 5));
            DEFAULT.nameFlagOverrides.Add(new NameFlagOverride("C", MyMapper.s("tailor,110"), 4));
            DEFAULT.nameFlagOverrides.Add(new NameFlagOverride("c", MyMapper.s("tailor,110"), 5));
            DEFAULT.nameFlagOverrides.Add(new NameFlagOverride("C", MyMapper.s("craft,100"), 4));
            DEFAULT.nameFlagOverrides.Add(new NameFlagOverride("c", MyMapper.s("craft,100"), 5));
            DEFAULT.nameFlagOverrides.Add(new NameFlagOverride("C", MyMapper.s("refine chemicals,97"), 4));
            DEFAULT.nameFlagOverrides.Add(new NameFlagOverride("c", MyMapper.s("refine chemicals,97"), 5));
            DEFAULT.nameFlagOverrides.Add(new NameFlagOverride("C", MyMapper.s("refine,80"), 4));
            DEFAULT.nameFlagOverrides.Add(new NameFlagOverride("c", MyMapper.s("refine,80"), 5));
            DEFAULT.nameFlagOverrides.Add(new NameFlagOverride("D", MyMapper.s("produce drugs,95"), 4));
            DEFAULT.nameFlagOverrides.Add(new NameFlagOverride("d", MyMapper.s("produce drugs,95"), 5));

            DEFAULT.nameFlagOverrides.Add(new NameFlagOverride("A", MyMapper.s("sculpt,100"), 4));
            DEFAULT.nameFlagOverrides.Add(new NameFlagOverride("a", MyMapper.s("sculpt,100"), 5));

            DEFAULT.nameFlagOverrides.Add(new NameFlagOverride("X", MyMapper.s("haul,10"), 4));
            ...
            DEFAULT.nameFlagOverrides.Add(new NameFlagOverride("R", MyMapper.s("research,0"), 4));
            DEFAULT.nameFlagOverrides.Add(new NameFlagOverride("r", MyMapper.s("research,0"), 5));

            HAULING.minimums.Add(MyMapper.s("haul,10"), 3);

            CLEANING.minimums.Add(MyMapper.s("clear snow,10"), 3);
            ...
            FOOD.maximums.Add(MyMapper.s("mine,100"), 6);
            FOOD.maximums.Add(MyMapper.s("drill,50"), 6);
            FOOD.maximums.Add(MyMapper.s("smith,115"), 6);
            FOOD.maximums.Add(MyMapper.s("work,75"), 6);
            FOOD.maximums.Add(MyMapper.s("produce components,50"), 6);
            FOOD.maximums.Add(MyMapper.s("tailor,110"), 6);
            FOOD.maximums.Add(MyMapper.s("sculpt,100"), 6);
            FOOD.maximums.Add(MyMapper.s("craft,100"), 6);
            FOOD.maximums.Add(MyMapper.s("refine chemicals,97"), 6);
            FOOD.maximums.Add(MyMapper.s("produce drugs,95"), 6);
            FOOD.maximums.Add(MyMapper.s("stonecut,90"), 6);
            FOOD.maximums.Add(MyMapper.s("refine,80"), 6);
            FOOD.maximums.Add(MyMapper.s("research,0"), 6);
            FOOD.maximums.Add(MyMapper.s("clear snow,10"), 6);
            FOOD.maximums.Add(MyMapper.s("clean,5"), 6);
